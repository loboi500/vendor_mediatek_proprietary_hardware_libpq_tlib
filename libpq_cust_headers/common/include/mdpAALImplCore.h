...
#if (CALTM_VERSION == CALTM_VERSION_3_5)
#ifdef Face_Adjsutment
  void vFaceContrastEnhanceLumaCurve(const uint16_t waCurCurve[mdpDRE_LUMA_CURVE_NUM], const uint16_t HECurve[mdpDRE_LUMA_CURVE_NUM], uint16_t waLumaCurve[mdpDRE_LUMA_CURVE_NUM], const uint32_t u4SkinRatio, const uint32_t face_DR_weight);
#endif // Face_Adjsutment
#endif
...
#if (CALTM_VERSION == CALTM_VERSION_3_5)
#ifdef Face_Adjsutment
  uint32_t face_adjustment_input_checker(const uint32_t lce_face_control_en, const uint32_t adaptive_APLComp_en, const uint32_t face_Comp_th, const uint32_t face_DR_weight, const uint32_t fdy);
  void vAPLComp_Weight_Interp(int32_t const x, int32_t const x0, int32_t const x1, int32_t const y0, int32_t const y1, int32_t &y);
  void vAPLCompCurve(const uint16_t waLumaCurveSrc[mdpDRE_LUMA_CURVE_NUM], uint16_t waLumaCurveDst[mdpDRE_LUMA_CURVE_NUM], uint32_t adaptive_APLComp_en, uint32_t aaplc_Max_High, uint32_t aaplc_Min_High, uint32_t aaplc_ThL_High, uint32_t aaplc_ThH_High, uint32_t aaplc_Max_Low, uint32_t aaplc_Min_Low, uint32_t aaplc_ThL_Low, uint32_t aaplc_ThH_Low);
  void vFaceAPLCompCurve(const uint32_t u4SkinRatio, const uint16_t waLumaCurveSrc[mdpDRE_LUMA_CURVE_NUM], uint16_t waLumaCurveDst[mdpDRE_LUMA_CURVE_NUM], const uint32_t fdy, uint32_t face_Comp_th);
#endif // Face_Adjsutment
#endif
...
private:
    ...
    uint16_t waLumaArray2_1[mdpDRE_LUMA_CURVE_NUM];
    uint16_t waLumaArray2_2[mdpDRE_LUMA_CURVE_NUM];

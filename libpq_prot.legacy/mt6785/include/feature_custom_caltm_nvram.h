...
typedef struct{
    ...
    MUINT32 ca_ltm_s_lower2;
    MUINT32 ca_ltm_s_upper2;
    MUINT32 ca_ltm_y_lower2;
    MUINT32 ca_ltm_y_upper2;
    MUINT32 ca_ltm_h_lower2;
    MUINT32 ca_ltm_h_upper2;
    MUINT32 ca_ltm_s_lower3;
    MUINT32 ca_ltm_s_upper3;
    MUINT32 ca_ltm_y_lower3;
    MUINT32 ca_ltm_y_upper3;
    MUINT32 ca_ltm_h_lower3;
    MUINT32 ca_ltm_h_upper3;
    MUINT32 ca_ltm_h_slope;
    MUINT32 ca_ltm_s_slope;
    MUINT32 ca_ltm_y_slope;
    MUINT32 ca_ltm_h_slope2;
    MUINT32 ca_ltm_s_slope2;
    MUINT32 ca_ltm_y_slope2;
    MUINT32 ca_ltm_h_slope3;
    MUINT32 ca_ltm_s_slope3;
    MUINT32 ca_ltm_y_slope3;
    MUINT32 bilateral_flt_en;
    MUINT32 bilateral_impulse_noise_en;
    MUINT32 bilateral_range_flt_slope;
    MUINT32 dre_bilateral_blending_wgt;
    MUINT32 dre_bilateral_blending_en;
    MUINT32 dre_bilateral_detect_en;
    MUINT32 have_bilateral_filter;
#endif

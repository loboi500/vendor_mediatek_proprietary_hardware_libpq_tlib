...
struct RszSWTuningReg
{
    ...
    int signal_enhance_mode;
    int etc_chroma_en;
    int etc_switch_max_min_en;
    int etc_ring_ctrl_en;
    int etc_sim_prot_en;
    int etc_sim_prot_blend_mode;
    int etc_luma_curve_select;
    int etc_chroma_curve_select;
    int etc_sim_prot_gaincontrol_zero;
    int etc_sim_prot_gaincontrol_base;
    int etc_sim_prot_gaincontrol_thr;
    int etc_sim_prot_gaincontrol_softcoring_gain;
    int etc_sim_prot_gaincontrol_softcoring_value;
    int etc_sim_prot_gaincontrol_gain;
    int etc_sim_prot_gaincontrol_coring_value;
    int etc_sim_prot_gaincontrol_limit;
    int etc_sim_prot_gaincontrol_bound;
    int etc_sim_prot_gaincontrol_softratio;
    int etc_blend;
#endif
};
...
void CZCalRegRef(int CalValue, int size, uint32_t* RefArray, uint32_t* RefValue);
